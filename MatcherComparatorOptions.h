...
namespace MatcherComparatorOptions {
  ...
  STrackMatcherComparatorConfig GetConfig() {
    ...
    STrackMatcherComparatorConfig cfg {
      .outFileName     = "matchComparison.typosFixed.pt10num1evt500pim.d8m2y2024.root",
      .newInFileName   = "input/merged/sPhenixG4_oneMatchPerParticleAndEmbedScanOn_fixedTypos_newMatcher.pt10num1evt500pim.d8m2y2024.root",
      .oldInFileName   = "input/merged/sPhenixG4_oneMatchPerParticleAndEmbedScanOn_fixedTypos_oldEval.pt10num1evt500pim.d8m2y2024.root",
